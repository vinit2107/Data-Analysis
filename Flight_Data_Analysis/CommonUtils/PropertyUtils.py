...
class PropertyReader:
    ...
    def validate_config(self, config: RawConfigParser):
        ...
        self.check_if_empty('database.url', config.get('credentials', 'aws_access_key_id'))
        self.check_if_empty('database.keyspace', config.get('credentials', 'aws_secret_access_key'))
    ...
    def readPropertyFile(self):
        ...
        try:
            ...
            config.read('../resources/config/configuration.properties')
